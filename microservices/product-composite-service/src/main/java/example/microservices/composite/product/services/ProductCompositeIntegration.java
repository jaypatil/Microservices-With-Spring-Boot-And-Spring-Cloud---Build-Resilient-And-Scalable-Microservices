package example.microservices.composite.product.services;
...
import example.api.core.recommendation.RecommendationService;
import example.api.core.review.Review;
import example.api.core.review.ReviewService;
...
import example.util.http.HttpErrorInfo;
