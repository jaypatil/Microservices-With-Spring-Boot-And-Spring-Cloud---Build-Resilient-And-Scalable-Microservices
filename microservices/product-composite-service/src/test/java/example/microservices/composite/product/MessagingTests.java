package example.microservices.composite.product;
...
import static example.api.event.Event.Type.CREATE;
import static example.api.event.Event.Type.DELETE;
import static example.microservices.composite.product.IsSameEvent.sameEventExceptCreatedAt;
...
import example.api.composite.product.ProductAggregate;
import example.api.composite.product.RecommendationSummary;
import example.api.composite.product.ReviewSummary;
import example.api.core.product.Product;
import example.api.core.recommendation.Recommendation;
import example.api.core.review.Review;
import example.api.event.Event;
